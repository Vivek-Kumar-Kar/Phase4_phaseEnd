...
namespace WebAppPh.Controllers
{
    public class CustLogInfoesController : Controller
    {
        private readonly KarssDbContext _context;

        public CustLogInfoesController(KarssDbContext context)
        {
            _context = context;
        }
        ...
        {
            var karssDbContext = _context.CustLogInfos.Include(c => c.User);
            return View(await karssDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'KarssDbContext.CustLogInfos'  is null.");
            }
            var custLogInfo = await _context.CustLogInfos.FindAsync(id);
            if (custLogInfo != null)
            {
