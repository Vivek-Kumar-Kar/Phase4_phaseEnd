...
namespace WebAppPh.Controllers
{
    public class UserInfoesController : Controller
    {
        ...
        public UserInfoesController(KarssDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.UserInfos != null ? 
                          ...
                          Problem("Entity set 'KarssDbContext.UserInfos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'KarssDbContext.UserInfos'  is null.");
            }
            var userInfo = await _context.UserInfos.FindAsync(id);
            if (userInfo != null)
            {
